            ...
            <div className={cx('inner')}>
                ...
                <div className={cx('menu')}>
                    <ul className={cx('menu-list')}>
                        <li>
                            <Link href="http://localhost:2002/lifestyle">LIFESTYLE</Link>
                        </li>
                        <li>
                            <Link href="http://localhost:2002/fashion">FASHION</Link>
                        </li>
                        <li>
                            <Link href="http://localhost:2002/cinema">CINEMA</Link>
                        </li>
                        <li>
                            <Link href="http://localhost:2002/grooming">GROOMING</Link>
                        </li>
                    </ul>
                </div>
